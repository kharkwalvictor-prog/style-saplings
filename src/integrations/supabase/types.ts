    ...
    Tables: {
      ...
      orders: {
        Row: {
          ...
          shipping_email_sent: boolean | null
      ...
      products: {
        Row: {
          category: string | null
          craft_type: Database["public"]["Enums"]["craft_type"]
          created_at: string
          description: string | null
      ...
      refund_requests: {
        Row: {
          ...
          request_type: Database["public"]["Enums"]["refund_request_type"]
          requested_at: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "refund_requests_replacement_order_id_fkey"
      ...
      restock_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "restock_history_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
