    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center px-4">
          ...
          <Link to="/blog" className="text-sm font-medium hover:underline" style={{ color: "#C4785A" }}>← Back to Blog</Link>
        </div>
        <Footer />
      </div>
    );
    ...
    <div className="min-h-screen">
      ...
      <article className="py-16 md:py-24 bg-background">
        <div className="max-w-[720px] mx-auto px-4 md:px-8">
          <Link to="/blog" className="inline-flex items-center gap-2 text-sm font-medium mb-6 px-4 py-2 rounded-full border border-border hover:bg-muted transition-colors" style={{ color: "#C4785A" }}>
            ← Back to Blog
          </Link>
          ...
          <div className="mt-12 pt-8 border-t">
            <Link to="/blog" className="text-sm font-medium hover:underline" style={{ color: "#C4785A" }}>
              ← Back to Blog
            </Link>
          </div>
        </div>
