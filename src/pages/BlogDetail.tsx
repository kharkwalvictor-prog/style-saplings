...
const BlogDetail = () => {
    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center px-4">
          ...
          <Link to="/blog" className="text-sm font-medium hover:underline text-[#4A6B45]">← Back to Blog</Link>
        </div>
        <Footer />
      </div>
    );
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Cover image */}
      {post.cover_image && (
        <div className="w-full h-[45vh] min-h-[240px] md:h-[55vh] overflow-hidden">
      ...
      <article className="py-16 md:py-24 bg-background">
        <div className="max-w-[720px] mx-auto px-4 md:px-8">
          <Link to="/blog" className="inline-flex items-center gap-2 text-sm font-medium mb-6 px-4 py-2 rounded-full border border-border hover:bg-muted transition-colors text-[#4A6B45]">
            ← Back to Blog
          </Link>
          ...
          {post.category && (
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="block text-[10px] uppercase tracking-[0.2em] font-medium mb-3 text-[#4A6B45]"
            >
              {post.category}
            </motion.span>
          )}
          ...
          <div className="mt-12 pt-8 border-t">
            <Link to="/blog" className="text-sm font-medium hover:underline text-[#4A6B45]">
              ← Back to Blog
            </Link>
          </div>
        </div>
